...
#_db = und.open("C:\\Users\\black\\OpenUnderstand\\JSON.udb")
#dbents = _db.ents()
...
if __name__ == "__main__":
    ...
    understand_refs, understand_counter = udb_open(
        address="C:\\Users\\black\\OpenUnderstand\\benchmark\\JSON\\JSON.udb",
        refrence=refrerence,
    )
    openund_refs, openund_counter = oudb_open(
        address="C:\\Users\\black\\OpenUnderstand\\JSON.udb",
        refrence=refrerence,
    )
